...
<body onload="Pageload()">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
           <div class="topnav approvernav">
                        ...
                        <a class="actived" href="/Notification_tab?pgno=0" class='production'>Notifications</a>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card db2">
                <div class="card-body">
                   <div class="form-group">
                      <div class="row">
                        <div class="dropdown">
                          <div class = 'row'>
                          <p class="subhead"><b> Notifications table </b>
                          ...
                          <p  class="btn btn-primary btn-sm runbtn Downexcel">Download entire table</p>&nbsp
                          <form enctype="multipart/form-data" method='POST' action='/fileupload3' id='upfile'>
                ...
                <!-- method='POST' action='/fileupload' -->
                        ...
                        <label for="filterText" class="selectlabel" style='margin-top: 6px;margin-right: 6px;'><b>Select by Approval Status: </b></label>
    ...
    <thead>
      <tr class="table_head" >
        ...
        <th style="width: 5% ...;display: none;">Section type</th>
        ...
        <th style="width: 1% ..."> Analyst </th>
        <th style="width: 1% ..."> Date of latest change </th>
        ...
        $(".edit").on('click', function() {
          ...
          $.ajax({
            ...
            success: function(response){
              ...
              var str = `<form action="/Savechanges_notify" method="POST"><div class='row'><div class="col-sm-6">
                          <div class='form-group'>
    ...
    $(".prevpage").on('click', function() {
      ...
      if(value1 == '0'){
        $('#prev').hide();
         ...
         window.location.replace('/Notification_tab?pgno='+value1)
      }
    });
  });
</script>
...
<script type="text/javascript">
      ...
      var webname = 'Notification'
      window.location.replace('/Download_singlepage_notification?webname='+webname+'&webid='+webid)
    });
</script>
<script type="text/javascript">
    ...
    if (del == true){
      $.ajax({
        ...
        success: function(response){
          ...
          window.location.replace('/Notification_tab?pgno='+pg)
        },
        error: function(error){
          console.log('U have done error')
          console.log(error);
 ...
 <script type="text/javascript">
  ...
  $('.Deletemultiple').on('click',function(){
    ...
    if(del == true){
      $.ajax({
        url: '/Delete_multiple_notify',
        type:'POST',
        data : JSON.stringify({'data': weblist,'data1':sectypelist}),
        contentType: "application/json",
        success: function(response){
